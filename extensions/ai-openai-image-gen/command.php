 ...
 * @return int
 */
function ai_openai_image_gen($args, &$context) {
    ...
    if (count($args) < 1) {
        $context['error'] = "Usage: generate_image_with_gpt <prompt> [size]\n";
        return 1;
    }

    // Extract arguments
    $prompt = $args[0];
    $size = $args[1] ?? "1024x1024";
...
//     'output_dir' => 'output'
// ];
// $args = ['a cyberpunk cityscape at night'];
// $result = generate_image_with_gpt($args, $context);
// if ($result === 0) {
