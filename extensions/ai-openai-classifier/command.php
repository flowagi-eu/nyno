...
<?php
/**
 * Generate a classification score using GPT-5 Chat Completion.
 *
 * @param array $args
 * @param array &$context
 * @return int
 */
function ai_openai_classifier($args, &$context) {
    ...
    // Usage check
    if (count($args) < 3) {
        $context['ai-openai-classifier::usage'] =
            "Usage: ai_openai_classifier <prompt> <classifier_title> <classifier_description> [reasoning_effort]\n"
